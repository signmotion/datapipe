...
Look at [changelog](https://pub.dev/packages/datapipe/changelog).

## 👋 Welcome

If you encounter any problems, feel free to [open an issue](https://github.com/signmotion/datapipe/issues). If you feel the package is missing a feature, please [raise a ticket](https://github.com/signmotion/datapipe/issues) on Github and I'll look into it. Requests and suggestions are warmly welcome. Danke!
...
The package **DataPipe** is open-source, stable and well-tested. Development happens on
